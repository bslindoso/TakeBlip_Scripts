function getOptionSelected(input, inputType, list, validation, intent, listMenu, listShortcut, apiName, contentAssistant, apiStatus) {
    ...
    if (validation.hasOwnProperty('apiStatus') && apiStatus !== null) {
      if (validation.apiStatus) {
        const result = validateStatusCode(input, apiStatus);
