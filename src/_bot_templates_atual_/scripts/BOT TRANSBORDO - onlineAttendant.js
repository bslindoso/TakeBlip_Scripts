let responseOnlineAttendant = JSON.stringify(
    {
        ...
        "resource": {
            ...
            "items": [
                {
                    "identity": "bruno.lindoso%40squadra.com.br@blip.ai",
                    "fullName": "Bruno Santos Lindoso",
                    "email": "bruno.lindoso@squadra.com.br",
                    "teams": ["Default"],
                    "status": "Online",
                    "isEnabled": true
                }
        ...
        "to": "pntransbordodev@msging.net/!msging-server-thwz5-82twgs87",
        "metadata": {
            "#command.uri": "lime://pntransbordodev@msging.net/attendants"
        }
    })
